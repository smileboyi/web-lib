// 参考文章
// https://juejin.im/post/5b5a89e4e51d4519721bbdac
// https://segmentfault.com/a/1190000006194584

// 将此文件放入vscode目录下面并进行如下配置（安装eslint和prettier插件配合使用）
// "editor.formatOnSave": true,
// "eslint.options": {
//   "configFile": "D:/Program Files/Microsoft VS Code/.eslintrc.js"
// }
...
module.exports = {
  ...
  'rules': {
    ...
    "complexity": [2, 9], // 限制圈复杂度，也就是类似if else能连续接多少个
    ...
    "indent": ["error", "tab", { "SwitchCase": 1 }], //强制一致的缩进风格
    "brace-style": [2, "1tbs", {
    ...
    "consistent-this": [0, "self"], //与获取当前环境的this是用一样的风格
    "eol-last": 2, //文件以换行符结束
